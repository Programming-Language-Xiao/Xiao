...
| [00C. 文档 lint 接线预研究](00c-doc-lint-wiring.md) | 记录 `missing_docs` 从未生效的缺口、两套覆盖率口径的差异、接线选项与触发条件 | 预研究（待决策） |
...
| 00C | [文档 lint 接线预研究](00c-doc-lint-wiring.md) | `missing_docs` 未接线的事实与实测数据、覆盖率两套口径、接线方案与代价 | 预研究（待决策） |
