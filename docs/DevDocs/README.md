...
| [00C. 文档 lint 接线实现交接](00c-doc-lint-wiring.md) | 统一 20 个 Rust crate 的 `missing_docs` 接线，补齐 rustc 与 repo-check 两套口径的文档缺口 | 已完成（方案 B） |
...
| 00C | [文档 lint 接线实现交接](00c-doc-lint-wiring.md) | 20 个 Rust crate 的 `missing_docs` 接线、44 个字段 Rustdoc、两套口径复测 | 已完成（方案 B） |
