...
| 11A | [虚拟环境与包管理](11a-environments-and-packages.md) | 项目隔离、多源包仓库、联邦源索引、共享缓存、锁定和管理命令 | 进行中（D1、E0、E1、E2A、E2B、E3A 已实现；**E3B 的前置并发冻结件 11A-CONC 已就绪**；E3B 交接文档已就绪，E3B–E3D 与远程源尚未开始） |
