...
/// 05-A 导入语句解析扩展；模块名与文件名不同，因此保留显式路径。
#[path = "parser/imports.rs"]
mod import_parser;
/// P0/P1 语句、表头、函数和控制流解析。
mod statements;
...
use crate::ast::{
    ...
    DictKey, EntryMode, Expression, LiteralKind, Name, Program, ScalarType, SetTypeAnnotation,
    Statement, TypeTerm, UnaryOperator,
};
